...
const faqs = [
  ...
  },
  {
    ...
    answer: "bKash, Nagad, Rocket, বা Bank Transfer-এ পেমেন্ট করতে পারবেন। কিস্তির ব্যবস্থাও আছে — বিস্তারিত জানতে WhatsApp-এ যোগাযোগ করুন (01729-879855)। আমরা আপনার সুবিধামতো পেমেন্ট প্ল্যান তৈরি করে দেব।",
  },
];
